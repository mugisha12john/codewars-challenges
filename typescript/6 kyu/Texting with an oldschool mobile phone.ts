...
//  A lot of them had different layouts, most notably for special characters and spaces, so for simplicity
// we'll be using a fictional model with 3x4 key layout shown below:
...
// 2 => 'a', 9999 => 'z', 111 => '?', *** => '+'
// Typing numbers
// To type numbers 0-9 and special characters *# - hold that key. Holding is represented by a number,
//  followed by a dash. Examples:

// 3- => '3', 5-5-5- => '555'
// Uppercase / Lowercase
// Initially the case is lowercase. To toggle between lowercase and uppercase letters,
// use the # symbol. Case switching should only be considered when next character is alphabetic (a-z). Examples:
...
//  you have to wait before pressing the same button again. Waiting is represented by adding a space
// between 2 (or more) such characters. Example:
